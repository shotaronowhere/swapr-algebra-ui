/*eslint-disable*/ module.exports = {
    messages: {
        ...
        "<0>Tip:</0> Removing pool tokens converts your position back into underlying tokens at the current rate, proportional to your share of the pool. Accrued fees are included in the amounts you receive.":
            "<0>Tip:</0> Removing pool tokens converts your position back into underlying tokens at the current rate, proportional to your share of the pool. Accrued fees are included in the amounts you receive.",
        "<0>Tip:</0> Use this tool to find SushiSwap or QuickSwap pools.": "<0>Tip:</0> Use this tool to find SushiSwap or QuickSwap pools.",
        ...
        "Added {0}": ["Added ", ["0"]],
        "Algebra on {0}": ["Algebra on ", ["0"]],
        "Allow Algebra to use your {0}": ["Allow Algebra to use your ", ["0"]],
        ...
        Allowed: "Allowed",
        Amount: "Amount",
        "An error occurred when trying to execute this swap. You may need to increase your slippage tolerance. If that does not work, there may be an incompatibility with the token you are trading. Note: fee on transfer and rebase tokens are incompatible with Algebra.":
            "An error occurred when trying to execute this swap. You may need to increase your slippage tolerance. If that does not work, there may be an incompatibility with the token you are trading. Note: fee on transfer and rebase tokens are incompatible with Algebra.",
        "An error occurred when trying to execute this swap. You may need to increase your slippage tolerance. If that does not work, there may be an incompatibility with the token you are trading. Note: fee on transfer and rebase tokens are incompatible with Uniswap V3.":
            "An error occurred when trying to execute this swap. You may need to increase your slippage tolerance. If that does not work, there may be an incompatibility with the token you are trading. Note: fee on transfer and rebase tokens are incompatible with Uniswap V3.",
        "An error occurred when trying to execute this swap. You may need to increase your slippage tolerance. If that does not work, there may be an incompatibility with the token you are trading. Note: rebase tokens are incompatible with Algebra.":
            "An error occurred when trying to execute this swap. You may need to increase your slippage tolerance. If that does not work, there may be an incompatibility with the token you are trading. Note: rebase tokens are incompatible with Algebra.",
        Approve: "Approve",
        ...
        "By adding this list you are implicitly trusting that the data is correct. Anyone can create a list, including creating fake versions of existing lists and lists that claim to represent projects that do not have one.":
            "By adding this list you are implicitly trusting that the data is correct. Anyone can create a list, including creating fake versions of existing lists and lists that claim to represent projects that do not have one.",
        "Calculate Proift": "Calculate Proift",
        Change: "Change",
        "Change your network to go back to L1": "Change your network to go back to L1",
        Claim: "Claim",
        ...
        "Collect as WMATIC": "Collect as WMATIC",
        ...
        "Connect Wwallet": "Connect Wwallet",
        ...
        "Connect wallet": "Connect wallet",
        "Connect wallet to find pools": "Connect wallet to find pools",
        ...
        "Create pool and add {0}/{1} liquidity": ["Create pool and add ", ["0"], "/", ["1"], " liquidity"],
        "Create pool.": "Create pool.",
        "Create {0}/{1} V3 pool": ["Create ", ["0"], "/", ["1"], " V3 pool"],
        "Create {0}/{1} pool": ["Create ", ["0"], "/", ["1"], " pool"],
        "Created!": "Created!",
        ...
        "Migrate from SushiSwap or QuickSwap": "Migrate from SushiSwap or QuickSwap",
        "Migrate your liquidity tokens from SushiSwap and QuickSwap to Algebra.": "Migrate your liquidity tokens from SushiSwap and QuickSwap to Algebra.",
        "Migrate your liquidity tokens from Uniswap V2 to Uniswap V3.": "Migrate your liquidity tokens from Uniswap V2 to Uniswap V3.",
        Migrating: "Migrating",
        "Min Price": "Min Price",
        "Min Priceddd": "Min Priceddd",
        "Min price": "Min price",
        "Min:": "Min:",
        ...
        "Oops! An unknown error occurred. Please refresh the page, or visit from another browser or device.":
            "Oops! An unknown error occurred. Please refresh the page, or visit from another browser or device.",
        "Optimism Scheduled Downtimes": "Optimism Scheduled Downtimes",
        "Optimism expects some scheduled downtime in the near future. <0>Read more.</0>": "Optimism expects some scheduled downtime in the near future. <0>Read more.</0>",
        "Optimistic Etherscan": "Optimistic Etherscan",
        "Optimistic L2 Gateway": "Optimistic L2 Gateway",
        ...
        "Please connect to the Polygon network.": "Please connect to the Polygon network.",
        "Please connect to the appropriate BSC / Polygon network.": "Please connect to the appropriate BSC / Polygon network.",
        "Please connect to the appropriate Kovan network.": "Please connect to the appropriate Kovan network.",
        "Please connect to the appropriate Polygon network.": "Please connect to the appropriate Polygon network.",
        "Please connect to the appropriate Ropsten network.": "Please connect to the appropriate Ropsten network.",
        ...
        "Pools for staking": "Pools for staking",
        "Popular pairs": "Popular pairs",
        ...
        "Price is outside specified price range. Single-asset deposit only.": "Price is outside specified price range. Single-asset deposit only.",
        ...
        "Remove {0}/{1} liquidity": ["Remove ", ["0"], "/", ["1"], " liquidity"],
        ...
        "Select a token to find your liquidity on SushiSwap or QuickSwap.": "Select a token to find your liquidity on SushiSwap or QuickSwap.",
        ...
        "Switch to L1 (Mainnet)": "Switch to L1 (Mainnet)",
        "The % you will earn in fees.": "The % you will earn in fees.",
        "The Algebra invariant x*y=k was not satisfied by the swap. This usually means one of the tokens you are swapping incorporates custom behavior on transfer.":
            "The Algebra invariant x*y=k was not satisfied by the swap. This usually means one of the tokens you are swapping incorporates custom behavior on transfer.",
        ...
        "The output token cannot be transferred. There may be an issue with the output token. Note: fee on transfer and rebase tokens are incompatible with Algebra.":
            "The output token cannot be transferred. There may be an issue with the output token. Note: fee on transfer and rebase tokens are incompatible with Algebra.",
        "The output token cannot be transferred. There may be an issue with the output token. Note: fee on transfer and rebase tokens are incompatible with Uniswap V3.":
            "The output token cannot be transferred. There may be an issue with the output token. Note: fee on transfer and rebase tokens are incompatible with Uniswap V3.",
        "The output token cannot be transferred. There may be an issue with the output token. Note: rebase tokens are incompatible with Algebra.":
            "The output token cannot be transferred. There may be an issue with the output token. Note: rebase tokens are incompatible with Algebra.",
        ...
        "This is an alpha release of Algebra on the {0} network.": ["This is an alpha release of Algebra on the ", ["0"], " network."],
        "This is an alpha release of Algebra on the {0} network. You must bridge L1 assets to the network to swap them.": [
            "This is an alpha release of Algebra on the ",
            ["0"],
            " network. You must bridge L1 assets to the network to swap them.",
        ],
        "This is an alpha release of Uniswap on the {0} network.": ["This is an alpha release of Uniswap on the ", ["0"], " network."],
        "This is an alpha release of Uniswap on the {0} network. You must bridge L1 assets to the network to swap them.": [
        ...
        "This transaction will not succeed due to price movement. Try increasing your slippage tolerance. Note: fee on transfer and rebase tokens are incompatible with Algebra.":
            "This transaction will not succeed due to price movement. Try increasing your slippage tolerance. Note: fee on transfer and rebase tokens are incompatible with Algebra.",
        "This transaction will not succeed due to price movement. Try increasing your slippage tolerance. Note: fee on transfer and rebase tokens are incompatible with Uniswap V3.":
            "This transaction will not succeed due to price movement. Try increasing your slippage tolerance. Note: fee on transfer and rebase tokens are incompatible with Uniswap V3.",
        "This transaction will not succeed due to price movement. Try increasing your slippage tolerance. Note: rebase tokens are incompatible with Algebra":
            "This transaction will not succeed due to price movement. Try increasing your slippage tolerance. Note: rebase tokens are incompatible with Algebra",
        ...
        "To stake your NFT you should approve Algebra to use it": "To stake your NFT you should approve Algebra to use it",
        ...
        "Unknown error{0}. Try increasing your slippage tolerance. Note: fee on transfer and rebase tokens are incompatible with Algebra.": [
            "Unknown error",
            ["0"],
            ". Try increasing your slippage tolerance. Note: fee on transfer and rebase tokens are incompatible with Algebra.",
        ],
        ...
        "Unknown error{0}. Try increasing your slippage tolerance. Note: rebase tokens are incompatible with Algebra.": [
            "Unknown error",
            ["0"],
        ...
        "You do not have any liquidity positions.": "You do not have any liquidity positions.",
        "You don’t have liquidity in this pool yet.": "You don’t have liquidity in this pool yet.",
        "You have {0} {currencyIdA} / {currencyIdB} positions": ["You have ", ["0"], " ", ["currencyIdA"], " / ", ["currencyIdB"], " positions"],
        "You must bridge L1 assets to the network to use them.": "You must bridge L1 assets to the network to use them.",
        "You must connect an account.": "You must connect an account.",
        "You must give the Algebra smart contracts permission to use your {0}. You only have to do this once per token.": [
        ...
        "{0, plural, one {Import token} other {Import tokens}}": [["0", "plural", { one: "Import token", other: "Import tokens" }]],
        "{0}": [["0"]],
        "{0} %": [["0"], " %"],
        "{0} <0/> per <1/>": [["0"], " <0/> per <1/>"],
        "{0} Bridge": [["0"], " Bridge"],
