    ...
    const Buttons = () =>
        !account ? (
            ...
            <AutoColumn gap={'md'}>
                ...
                {mustCreateSeparately && (
                    <ButtonError disabled={!isValid || attemptingTxn || !position}>
                        {attemptingTxn ? (
                            ...
                            <Text fontWeight={500}>{errorMessage ? errorMessage :
                                <Trans>Create</Trans>}</Text>
                        )}
                    </ButtonError>
                )}
                <button className={'btn primary pv-1 br-12 b'}
                ...
                >
                    <Text fontWeight={500}>
                        {mustCreateSeparately ? <Trans>Add</Trans> : errorMessage ? errorMessage :
                            <Trans>Preview</Trans>}
                    </Text>
                </button>
            </AutoColumn>
            ...
            <TransactionConfirmationModal
                ...
                content={() => (
                    <ConfirmationModalContent
                        ...
                        bottomContent={() => (
                            <ButtonPrimary style={{ marginTop: '1rem', color: 'white' }}
                                           onClick={onAdd}>
            ...
            <Card classes={'p-2 br-24'}>
                ...
                <div className={'add-liquidity pt-1 mt-1'} data-wide={!hasExistingPosition && !networkFailed}>
                    ...
                    <Card
                        ...
                        data-disabled={tickLower === undefined || tickUpper === undefined || invalidPool || invalidRange}>
                        <TYPE.label>
                            {hasExistingPosition ?
