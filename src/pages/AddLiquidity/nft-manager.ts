...
import { SelfPermit, PermitOptions } from './self-permit'
...
export abstract class NonfungiblePositionManager extends SelfPermit {
  ...
  public static addCallParameters(position: Position, options: AddLiquidityOptions): MethodParameters {
    ...
    if (options.useNative) {
      ...
      invariant(position.pool.token0.equals(wrapped) || position.pool.token1.equals(wrapped), 'NO_NATIVE')
    ...
    const a = NonfungiblePositionManager.INTERFACE.encodeFunctionData('multicall', [calldatas])
