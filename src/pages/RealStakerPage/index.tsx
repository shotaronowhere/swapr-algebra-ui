...
export default function RealStakerPage({}) {
    ...
    const { stakerHandler, stakerClaimHandler, stakerUnstakeHandler, frozenStakedHandler, frozenStaked, claimLoading, unstakeLoading, stakeLoading, stakerHash, setStakedHash } =
