                ...
                isMobileOnly ?
                    <div className={'f f-ac f-js w-100'}>
                        <div className={'progress-circle-wrapper'}
                             style={{ background: `conic-gradient(rgb(3, 133, 255)${100 / steps.length * (completedSteps.length + 1)}%,rgb(242, 242, 242)${100 / steps.length * (completedSteps.length + 1)}%)` }}>
                        ...
                        <div className={'ml-1'}>
                            <h3 style={{whiteSpace: 'break-spaces', lineHeight: '1.1rem'}} className={'mb-025'}>{steps[completedSteps.length]?.title}</h3>
                            <h4 className={'fs-085 c-lg l'}>Next step: {steps[completedSteps.length + 1] ? steps[completedSteps.length + 1].title : 'Finish'}</h4>
                        </div>
                    ...
                    steps.map((el, i) => (
                        ...
                        >
                            <div
                                className={`stepper__circle mr-1 f f-ac f-jc ${i === completedSteps.length && !end ? 'current' : ''} ${completedSteps.length - 1 >= i || end ? 'done' : ''} `}>{i + 1}</div>
