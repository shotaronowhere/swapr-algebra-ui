...
export function SelectPair() {
    const popularPairs: any[] = [["0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174", "0x7ceb23fd6bc0add59e62ac25578270cff1b9f619"]];
    ...
    return (
        <div className="select-pair-wrapper f">
            ...
            <div className="token-pairs__popular-wrapper ml-2">
