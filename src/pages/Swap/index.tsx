                                ...
                                <GreyCard style={{
                                    ...
                                    <TYPE.main mb='4px'>
                                        {isLoadingRoute ? (
                                            ...
                                            <Trans>Insufficient liquidity for this trade. Try
                                                enabling multi-hop trades.</Trans>
                                        ) : (
                        ...
                        >
                          ...
                          />
                            ...
                            {approvalState === ApprovalState.APPROVED || signatureState === UseERC20PermitState.SIGNED ? (
                                ...
                                <Trans>Allow Algebra to use
                                    your {currencies[Field.INPUT]?.symbol}</Trans>
                            )}
                        </span>
                                                {approvalState === ApprovalState.PENDING ? (
                                                    <Loader stroke='white'
                                                ...
                                                signatureState === UseERC20PermitState.SIGNED ? (
                                                    ...
                                                    <MouseoverTooltip
                                                        text={
                                                            <Trans>
                                                                You must give the Algebra smart
                                                                contracts permission to use
                                                                your{' '}
                                                                {currencies[Field.INPUT]?.symbol}.
                                                                You only have to do this once per
                                                                token.
                                                            </Trans>
                                                        }
                                                    >
