                            ...
                            <BodyWrapper>
                                <Switch>
                                    <Route exact path={`${path}`}>
                                        <Redirect
                                            to={`${path}/${account ? "farms" : "future-events"}`}
                                        />
                                    </Route>
                                    <Route exact path={`${path}/rewards`}>
                                        ...
                                        <PageTitle
                                            ...
                                            refreshHandler={() =>
                                                account
                                                    ? fetchRewards?.fetchRewardsFn(true)
                                                    : undefined
                                            }
                                    ...
                                    <Route exact path={`${path}/farms`}>
                                        ...
                                        <PageTitle
                                            ...
                                            refreshHandler={() =>
                                                account
                                                    ? fetchTransferredPositions?.fetchTransferredPositionsFn(
                                                          true
                                                      )
                                                    : undefined
                                            }
                                            isLoading={
                                                fetchTransferredPositions?.transferredPositionsLoading
                                            }
                                        />
                                        {account ? (
                                            <StakerMyStakes
                                                data={
                                                    fetchTransferredPositions?.transferredPositions
                                                }
                                                refreshing={
                                                    fetchTransferredPositions?.transferredPositionsLoading
                                                }
                                    ...
                                    <Route exact path={`${path}/future-events`}>
                                        ...
                                        <PageTitle
                                            title={"Future events"}
                                            refreshHandler={() =>
                                                fetchFutureEvents?.fetchFutureEventsFn(true)
                                            }
                                    ...
                                    <Route exact path={`${path}/current-events`}>
                                        ...
                                        <PageTitle
                                            ...
                                            refreshHandler={() =>
                                                fetchCurrentEvents?.fetchCurrentEventsFn(true)
                                            }
