        ...
        <AutoColumn gap='md'>
            <AutoColumn gap='sm'>
                <RowFixed>
                    ...
                    <QuestionHelper
                        text={
                            <Trans>Your transaction will revert if the price changes unfavorably by
                                more than this percentage.</Trans>
                        }
                    />
                </RowFixed>
                <RowBetween>
            ...
            {showCustomDeadlineRow && (
                <AutoColumn gap='sm'>
                    ...
                    <RowFixed>
                        <OptionCustom style={{ width: '80px' }} warning={!!deadlineError}
                                      tabIndex={-1}>
                            <Input
