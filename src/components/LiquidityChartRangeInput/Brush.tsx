                ...
                {localBrushExtent && (
                    <>
                        ...
                        <g transform={`translate(${Math.max(0, xScale(localBrushExtent[0]))}, 0)`}>
                            <svg width={xScale(localBrushExtent[1]) - xScale(localBrushExtent[0])}>
                                <line stroke="#2797FF" strokeWidth="2" x1="0" x2={xScale(localBrushExtent[1])} y1={innerHeight - 2} y2={innerHeight - 2}></line>
                            </svg>
                        </g>

                        {westHandleInView ? (
                            <g transform={`translate(${Math.max(0, xScale(localBrushExtent[0])) + 7}, ${innerHeight - 9}), scale(${flipWestHandle ? "-1" : "1"}, 1)`}>
                  ...
                  <HandleAccent d={brushHandleAccentPath()} /> */}
                                    <path
                                        ...
                                        strokeWidth="3"
                                    />
                                    <line x1={7} x2={7} y1={0} y2={-innerHeight} stroke="#2797FF" strokeWidth="1"></line>
                                </g>
                        ...
                        {/* east handle */}
                        {eastHandleInView ? (
                            <g transform={`translate(${xScale(localBrushExtent[1]) - 7}, ${innerHeight - 9}), scale(${flipEastHandle ? "-1" : "1"}, 1)`}>
                                <g style={{ userSelect: "none", pointerEvents: "none" }}>
