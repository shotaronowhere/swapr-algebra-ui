...
import { Body, DesktopTextBreak, L2Icon, LinkOutCircle, LinkOutToBridge, Wrapper } from './styled'
    ...
    return (
        <Wrapper darkMode={darkMode} chainId={chainId} logoUrl={info.logoUrl}>
            ...
            <Body>
                ...
                <DesktopTextBreak /> <Trans>You must bridge L1 assets to the network to use
                them.</Trans>
            </Body>
