    ...
    useEffect(() => {
        ...
        async function processTicks() {
            const _data = await Promise.all(
                data.ticksProcessed.map(async (t: any, i: any) => {
                    ...
                    const pool = token0 && token1 ? new Pool(_token0, _token1, 500, sqrtPriceX96, t.liquidityActive, t.tickIdx, mockTicks) : undefined
