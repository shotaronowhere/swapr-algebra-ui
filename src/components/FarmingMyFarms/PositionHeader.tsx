        ...
        <div className={"my-farms__position-card__header flex-s-between mb-1 br-8 p-1"}>
            <div className={"my-farms__position-card__header__row"}>
                ...
                <div className={"f f-ac ml-2 mxs_ml-0 mxs_mv-1"}>
                    <CurrencyLogo currency={new Token(97, el.token0, 18, el.pool.token0.symbol) as WrappedCurrency} size={"35px"} />
                    <CurrencyLogo currency={new Token(97, el.token1, 18, el.pool.token1.symbol) as WrappedCurrency} size={"35px"} style={{ marginLeft: "-1rem" }} />
                    <div className={"ml-05"}>
