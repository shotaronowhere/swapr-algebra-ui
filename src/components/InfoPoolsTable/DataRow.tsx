    ...
    return (
        <div>
            ...
            >
                ...
                <LabelStyled center end={1} fontWeight={400}>
                    {poolData.farmingApr.value > 0 ? (
                        <FarmingLink to={`/farming/${poolData.farmingApr.type === FarmingType.ETERNAL ? "infinite-farms" : "limit-farms"}`} apr={poolData.farmingApr.value > 0}>
                            {formatPercent(poolData.farmingApr.value)}
                        </FarmingLink>
                    ) : (
                        <span>-</span>
                    )}
