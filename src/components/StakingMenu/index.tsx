...
import { MenuListItem, MenuListItemTitle, MenuListItemIcon, MenuList } from './styled'
    ...
    <MenuList>
      {stakingMenuList.map((el, i) => (
        <MenuListItem
          ...
          key={i}
        >
          {el.title === 'Future events' ? <FarmingInfoLabel isEvents={Boolean(startTime.trim())} /> : null}
