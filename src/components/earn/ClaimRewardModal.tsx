        ...
        if (stakingContract && stakingInfo?.stakedAmount && account) {
            ...
            await stakingContract
                ...
                .catch((error: any) => {
                    setAttempting(false)
                    if (err.code !== 4001) {
                        throw new Error('Claiming reward ' + error.message)
                    }
                })
        }
    }
            ...
            {!attempting && !hash && (
                <ContentWrapper gap='lg'>
                    ...
                    <TYPE.subHeader style={{ textAlign: 'center' }}>
                        <Trans>When you claim without withdrawing your liquidity remains in the
                            mining pool.</Trans>
                    </TYPE.subHeader>
                    <ButtonError disabled={!!error} error={!!error && !!stakingInfo?.stakedAmount}
