...
export function InfoTotalStats({ data, isLoading, refreshHandler, blocksFetched, poolsStat }: InfoTotalStatsProps) {
    ...
    return (
        <div className={'total-stats-wrapper'}>
            <StatCard isLoading={isLoading} data={_data?.tvlUSD} title={'Total Value Locked'} style={'mr-f-05 mxs_m-0'} />
            <StatCard isLoading={isLoading} data={_data?.volumeUSD} title={'Volume 24H'} style={'ml-l-05 mxs_m-0'} />
        </div>
    )
}
