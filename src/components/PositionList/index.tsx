...
export default function PositionList({ positions }: PositionListProps) {
    ...
    return (
        <>
            {
                _positionsOnOldFarming.length && <OldFarmingWarning className='f full-w p-1 mb-1'>
                    <AlertCircle size={'24px'}/>
                    <span>{`Due to release of Tier Farming, we have updated our contracts.`}</span>
                    <a href="https://old.algebra.finance/#/farming/farms" target={'_blank'} rel={'noreferrer noopener'}>Withdraw previous positions →</a>
                </OldFarmingWarning>
            }
