...
export type ABIChangedEvent = TypedEvent<[string, BigNumber] & { node: string; contentType: BigNumber }>;

export type AddrChangedEvent = TypedEvent<[string, string] & { node: string; a: string }>;

export type AddressChangedEvent = TypedEvent<[string, BigNumber, string] & {
    node: string;
    coinType: BigNumber;
    newAddress: string;
}>;

export type AuthorisationChangedEvent = TypedEvent<[string, string, string, boolean] & {
    node: string;
    owner: string;
    target: string;
...
export type ContenthashChangedEvent = TypedEvent<[string, string] & { node: string; hash: string }>;

export type DNSRecordChangedEvent = TypedEvent<[string, string, number, string] & {
    node: string;
    name: string;
    resource: number;
    record: string;
...
export type DNSRecordDeletedEvent = TypedEvent<[string, string, number] & { node: string; name: string; resource: number }>;

export type DNSZoneClearedEvent = TypedEvent<[string] & { node: string }>;

export type InterfaceChangedEvent = TypedEvent<[string, string, string] & {
    node: string;
    interfaceID: string;
    implementer: string;
}>;

export type NameChangedEvent = TypedEvent<[string, string] & { node: string; name: string }>;

export type PubkeyChangedEvent = TypedEvent<[string, string, string] & { node: string; x: string; y: string }>;

export type TextChangedEvent = TypedEvent<[string, string, string] & { node: string; indexedKey: string; key: string }>;
...
export class EnsPublicResolver extends BaseContract {
    ...
    filters: {
        ...
        'AddressChanged(bytes32,uint256,bytes)'(
            ...
            coinType?: null,
            newAddress?: null
        ): TypedEventFilter<[string, BigNumber, string],
        ...
        'AuthorisationChanged(bytes32,address,address,bool)'(
            ...
            target?: string | null,
            isAuthorised?: null
        ): TypedEventFilter<[string, string, string, boolean],
        ...
        'DNSRecordChanged(bytes32,bytes,uint16,bytes)'(
            ...
            resource?: null,
            record?: null
        ): TypedEventFilter<[string, string, number, string],
        ...
        'InterfaceChanged(bytes32,bytes4,address)'(
            ...
            implementer?: null
        ): TypedEventFilter<[string, string, string],
