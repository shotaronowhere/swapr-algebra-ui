...
interface FiniteFarmingInterface extends ethers.utils.Interface {
    functions: {
...
export class FiniteFarming extends BaseContract {
    interface: FiniteFarmingInterface
    functions: {
        attachIncentive(
            key: {
                rewardToken: string;
    ...
    filters: {
        ...
        FarmStarted(
            ...
            incentiveId?: BytesLike | null,
            liquidity?: null
        ): TypedEventFilter<[BigNumber, string, BigNumber],
        ...
        IncentiveAttached(
            ...
            startTime?: null,
            endTime?: null
        ): TypedEventFilter<[string, string, string, string, BigNumber, BigNumber],
            {
                rewardToken: string;
                bonusRewardToken: string;
                pool: string;
