...
export const {
    ...
    useFetchIncentiveQuery,
    useLazyFetchIncentiveQuery,
    useFetchPoolQuery,
    ...
    useSharedPositionsQuery,
    useLazySharedPositionsQuery,
    useTransferedPositionsForPoolQuery,
    useLazyTransferedPositionsForPoolQuery,
    usePositionsOwnedForPoolQuery,
    useLazyPositionsOwnedForPoolQuery,
    useTopPoolsQuery,
