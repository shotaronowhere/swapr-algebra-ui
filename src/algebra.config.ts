...
export default {
    CHAIN_PARAMS: {
        ...
        [10200]: {
            ...
            nativeCurrency: { name: "XDAI", symbol: "XDAI", decimals: 18, logo: XDAI_LOGO },
            wrappedNativeCurrency: { name: "Wrapped XDAI", symbol: "WXDAI", decimals: 18, address: "0x18c8a7ec7897177E4529065a7E7B0878358B3BfF", logo: WXDAI_LOGO },
            rpcURL: "https://rpc.chiado.gnosis.gateway.fm",
            blockExplorerURL: "https://gnosis-chiado.blockscout.com",
            blockExplorerDomain: "gnosis-chiado.blockscout.com",
        },
    },
    ...
    DEFAULT_TOKEN_LIST: {
        ...
        [10200]: {
            ...
            stableTokenForUSDPrice: { address: "0x18c8a7ec7897177E4529065a7E7B0878358B3BfF", name: "Wrapped XDAI", symbol: "WXDAI", decimals: 18 },
            // Real tokens and their possible fake names. Used for token launch safety
            filterForScamTokens: {
                tokensForCheck: {},
                possibleFakeNames: [],
    ...
    V3_CONTRACTS: {
        ...
        [10200]: {
            POOL_DEPLOYER_ADDRESS: "0xFc94182545d3aE1BC9995b4420f33B324bA4d670",
            FACTORY_ADDRESS: "0x18A96692BebcF60b83a09670dF9cbFCaEcaEb752",
            QUOTER_ADDRESS: "0xBd2DcDe0c8cD06047706e1F3bB82857D29d13521",
            SWAP_ROUTER_ADDRESS: "0x95612FA079C0e99456AA224F00C4959Dbd278C6b",
            NONFUNGIBLE_POSITION_MANAGER_ADDRESS: "0x594BC40CBb3E714F18d99FF59245A9e614BDB3bC",
            MULTICALL_ADDRESS: "0xbdB5B68A8201212f0D7840ab7315c492673e87bB",
            MIGRATOR_ADDRESS: "",
            FARMING_CENTER_ADDRESS: "0xe7B76C7A4d167acF601ed4DBeE25d9588dbd6e4a",
            LIMIT_FARMING_ADDRESS: "0x36642aa68A2b172c8FB077109088C50b8f3d5CF2",
            ETERNAL_FARMING_ADDRESS: "0xb657C4cB4205B9d7fF7Dedd14BA1f2b9ceCc245F",
            POOL_INIT_CODE_HASH: "0xbce37a54eab2fcd71913a0d40723e04238970e7fc1159bfd58ad5b79531697e7",
        },
    },
